...
export const todoPlan = {
  ...
  criticalFixes: [
    ...
    },
    {
      ...
      details:
        "Update categories array so name and href match correctly (All->Electronics, Shirts->Clothing, Stickers->Home&Garden)",
      //DONE
    },
    {
      id: "CF-003",
    ...
    },
    {
      ...
      details:
        "SQL: CREATE TABLE products (id serial PRIMARY KEY, name text, price text, image text, featured boolean DEFAULT false, badge text, category text, description text)",
      //DONE
    },
    {
      id: "CF-005",
      ...
      details:
        "SQL: CREATE TABLE users (id uuid PRIMARY KEY REFERENCES auth.users, is_admin boolean DEFAULT false, created_at timestamp DEFAULT now())",
      //DONE
    },
  ],
  ...
  cartSystem: [
    ...
    },
    {
      ...
      details:
        "Create CartProvider with state for cart items, loading, and methods: addToCart, removeFromCart, updateQuantity, clearCart, getCartTotal, getCartCount",
    },
    {
      id: "CART-004",
      priority: "🔴 Critical",
    ...
    },
    {
      ...
      details:
        "Server action to insert/update cart_items, handle quantity increment if item exists",
    },
    {
      id: "CART-007",
      priority: "🔴 Critical",
    ...
    },
    {
      ...
      details:
        "Display cart items list with product image, name, price, quantity controls, remove button, and total",
    },
    {
      id: "CART-014",
      priority: "🔴 Critical",
      ...
      details:
        "Reusable component for each cart item with image, details, quantity +/- buttons, remove button",
    },
    {
      id: "CART-015",
      priority: "🔴 Critical",
    ...
    },
    {
      ...
      file: "app/cart/page.tsx",
      details:
        "Show 'Your cart is empty' message with 'Continue Shopping' button when cart is empty",
    },
    {
      id: "CART-017",
      priority: "🟡 High",
  ...
  checkoutFlow: [
    {
      ...
      details:
        "SQL: CREATE TABLE orders (id serial PRIMARY KEY, user_id uuid REFERENCES auth.users, status text DEFAULT 'pending', total text, shipping_address jsonb, created_at timestamp DEFAULT now())",
    },
    {
      id: "CHECKOUT-002",
      priority: "🟡 High",
      ...
      details:
        "SQL: CREATE TABLE order_items (id serial PRIMARY KEY, order_id integer REFERENCES orders, product_id integer REFERENCES products, quantity integer, price text)",
    },
    {
      id: "CHECKOUT-003",
      priority: "🟡 High",
      ...
      file: "lib/types.ts",
      details:
        "Define Order type with id, user_id, status, total, shipping_address, created_at, items",
    },
    {
      id: "CHECKOUT-004",
      priority: "🟡 High",
    ...
    },
    {
      ...
      details:
        "UI mockup of payment form (card number, expiry, CVV) - non-functional, portfolio only",
    },
    {
      id: "CHECKOUT-008",
      priority: "🟡 High",
